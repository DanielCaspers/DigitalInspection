...
{
	public class VehicleHistoryHttpService: HttpClientService<VehicleHistoryItem>
	{
		...
		{
			var httpClient = HttpClientService<VehicleHistoryItem>.InitializeHttpClient(userClaims, false);
